...
6. If you did everything correct, https://vathasav.github.io/apidocstest/ will lead to your new docs
...
- Documentation(ReDoc): https://vathasav.github.io/apidocstest/
- SwaggerUI: https://vathasav.github.io/apidocstest/swagger-ui/
- Look full spec:
    + JSON https://vathasav.github.io/apidocstest/swagger.json
    + YAML https://vathasav.github.io/apidocstest/swagger.yaml
- Preview spec version for branch `[branch]`: https://vathasav.github.io/apidocstest/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://vathasav.github.io/apidocstest/ with url from the message: `Server started <url>`
